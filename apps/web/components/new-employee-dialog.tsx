...
function NewEmployeeForm() {
  ...
  // creating a second employee); reopening the dialog for a genuinely new
  // employee remounts the form and gets a fresh key.
...
export function NewEmployeeDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
  return (
    <Dialog open={open} onClose={onClose} title="New employee">
